...
data class GameRules(
     ...
     */
    @SerialName("routes") val puzzleRoutes: List<Route> = listOf(),
     ...
     * All valid guesses.
     */
    @SerialName("stops") val stops: List<String> = listOf(),
     ...
     */
    @SerialName("max") val maxGuessCount: Int = 6,
     ...
     * will be discarded.
     */
    @SerialName("lvlNumber") val puzzleNumber: Int = -1
)
